...
--
-- Estructura de tabla para la tabla `jcg_assets`
--

CREATE TABLE IF NOT EXISTS `jcg_assets` (
...
--
-- Volcado de datos para la tabla `jcg_assets`
--

INSERT INTO `jcg_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(32, 27, 19, 20, 3, 'com_content.article.1', 'Test1', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jcg_banners`
--

CREATE TABLE IF NOT EXISTS `jcg_banners` (
...
--
-- Estructura de tabla para la tabla `jcg_banner_clients`
--

CREATE TABLE IF NOT EXISTS `jcg_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `jcg_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `jcg_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `jcg_categories`
--

CREATE TABLE IF NOT EXISTS `jcg_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `jcg_categories`
--

INSERT INTO `jcg_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `jcg_contact_details`
--

CREATE TABLE IF NOT EXISTS `jcg_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `jcg_content`
--

CREATE TABLE IF NOT EXISTS `jcg_content` (
...
--
-- Volcado de datos para la tabla `jcg_content`
--

INSERT INTO `jcg_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 32, 'Test1', 'test-1', '', '<p>qwerty</p>', '', 1, 0, 0, 2, '2011-07-05 20:29:33', 42, '', '2011-07-05 20:33:12', 42, 0, '0000-00-00 00:00:00', '2011-07-05 20:29:33', '0000-00-00 00:00:00', '', '', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","alternative_readmore":"","article_layout":""}', 2, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jcg_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `jcg_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `jcg_content_rating`
--

CREATE TABLE IF NOT EXISTS `jcg_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `jcg_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `jcg_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `jcg_extensions`
--

CREATE TABLE IF NOT EXISTS `jcg_extensions` (
...
INSERT INTO `jcg_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Estructura de tabla para la tabla `jcg_languages`
--

CREATE TABLE IF NOT EXISTS `jcg_languages` (
...
--
-- Volcado de datos para la tabla `jcg_languages`
--

INSERT INTO `jcg_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `published`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jcg_menu`
--

CREATE TABLE IF NOT EXISTS `jcg_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `jcg_menu_types`
--

CREATE TABLE IF NOT EXISTS `jcg_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `jcg_messages`
--

CREATE TABLE IF NOT EXISTS `jcg_messages` (
...
--
-- Estructura de tabla para la tabla `jcg_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `jcg_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `jcg_modules`
--

CREATE TABLE IF NOT EXISTS `jcg_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `jcg_modules_menu`
--

CREATE TABLE IF NOT EXISTS `jcg_modules_menu` (
...
--
-- Volcado de datos para la tabla `jcg_modules_menu`
--

INSERT INTO `jcg_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `jcg_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `jcg_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `jcg_redirect_links`
--

CREATE TABLE IF NOT EXISTS `jcg_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `jcg_schemas`
--

CREATE TABLE IF NOT EXISTS `jcg_schemas` (
...
--
-- Estructura de tabla para la tabla `jcg_session`
--

CREATE TABLE IF NOT EXISTS `jcg_session` (
...
--
-- Volcado de datos para la tabla `jcg_session`
--
...
--
-- Estructura de tabla para la tabla `jcg_template_styles`
--

CREATE TABLE IF NOT EXISTS `jcg_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `jcg_template_styles`
--
...
--
-- Estructura de tabla para la tabla `jcg_updates`
--

CREATE TABLE IF NOT EXISTS `jcg_updates` (
...
--
-- Estructura de tabla para la tabla `jcg_update_categories`
--

CREATE TABLE IF NOT EXISTS `jcg_update_categories` (
...
--
-- Estructura de tabla para la tabla `jcg_update_sites`
--

CREATE TABLE IF NOT EXISTS `jcg_update_sites` (
...
--
-- Volcado de datos para la tabla `jcg_update_sites`
--

INSERT INTO `jcg_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `jcg_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `jcg_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `jcg_update_sites_extensions`
--

INSERT INTO `jcg_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Estructura de tabla para la tabla `jcg_usergroups`
--

CREATE TABLE IF NOT EXISTS `jcg_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `jcg_usergroups`
--

INSERT INTO `jcg_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Estructura de tabla para la tabla `jcg_users`
--

CREATE TABLE IF NOT EXISTS `jcg_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `jcg_users`
--
...
--
-- Estructura de tabla para la tabla `jcg_user_profiles`
--

CREATE TABLE IF NOT EXISTS `jcg_user_profiles` (
...
--
-- Estructura de tabla para la tabla `jcg_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `jcg_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `jcg_user_usergroup_map`
--

INSERT INTO `jcg_user_usergroup_map` (`user_id`, `group_id`) VALUES
(42, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `jcg_viewlevels`
--

CREATE TABLE IF NOT EXISTS `jcg_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla `jcg_viewlevels`
--

INSERT INTO `jcg_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `jcg_weblinks`
--

CREATE TABLE IF NOT EXISTS `jcg_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `userFB`
--
